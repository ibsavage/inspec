...
describe registry_key('HKLM\System\Test') do
  ...
  it { should have_property_value("multistring value", :multi_string, %w{test multi string data}) }
  it { should have_property_value("Multistring Value", :multi_string, %w{test multi string data}) }
...
describe windows_registry_key('HKLM\System\Test') do
  ...
  it { should have_property_value("multistring value", :type_multistring, %w{test multi string data}) }
